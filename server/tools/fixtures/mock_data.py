...
class MockData:
    ...
    @staticmethod
    def get_mock_chunks_jee() -> List[Dict[str, Any]]:
        """Mock RAG chunks for JEE curriculum context."""
        return [
            {
                "chunk_id": "jee_001",
                "document_id": "jee_math_curriculum",
                "chunk_text": """Relations and Functions - Basics
                A relation is a set of ordered pairs. A function is a special relation where each input has exactly one output.
                Key concepts: domain, range, codomain, inverse functions, composition of functions.
                Applications: Function notation f(x), vertical line test for functions.""",
                "embedding": None,  # Will be generated by LLM
                "metadata": {
            ...
            },
            {
                "chunk_id": "jee_002",
                "document_id": "jee_math_curriculum",
                "chunk_text": """Matrices and Determinants - Advanced
                Matrices are rectangular arrays of numbers. Important operations: addition, subtraction, multiplication, transpose.
                Determinants: Numerical value associated with square matrices. Properties and applications in solving system of linear equations.
                Types of matrices: Identity, Diagonal, Symmetric, Singular.""",
                "embedding": None,
                "metadata": {
            ...
            },
            {
                "chunk_id": "jee_003",
                "document_id": "jee_math_curriculum",
                "chunk_text": """Calculus - Limits and Continuity
                Limit of a function as x approaches a value. Continuous functions and their properties.
                Fundamental theorem: Derivative as limit of difference quotient.
                Applications: Rate of change, optimization, curve sketching.
                Common derivatives and integration formulas.""",
                "embedding": None,
                "metadata": {
                    "topic": "Calculus",
                    "difficulty": "Advanced",
            ...
            },
            {
                "chunk_id": "jee_004",
                "document_id": "jee_math_curriculum",
                "chunk_text": """Vectors and Vector Spaces
                Vectors: Quantities with magnitude and direction. Notation and representation in 2D and 3D.
                Operations: Addition, scalar multiplication, dot product, cross product.
                Vector equation of lines and planes. Applications in coordinate geometry.""",
                "embedding": None,
                "metadata": {
                    "topic": "Vectors",
                    "difficulty": "Intermediate",
    ...
    @staticmethod
    def get_mock_chunks_cbse() -> List[Dict[str, Any]]:
        """Mock RAG chunks for CBSE curriculum context."""
        return [
            {
                "chunk_id": "cbse_001",
                "document_id": "cbse_physics_electrostatics",
                "chunk_text": """Electric Charge and Coulomb's Law
                Electric charge is a fundamental property of matter. Types: positive and negative charges.
                Coulomb's Law: Force between two charges F = k*q1*q2/r² where k = 9×10^9 N⋅m²/C².
                Principle of superposition: Net force is vector sum of individual forces.
                Applications: Equilibrium of charged particles.""",
                "embedding": None,
                "metadata": {
            ...
            },
            {
                "chunk_id": "cbse_002",
                "document_id": "cbse_physics_electrostatics",
                "chunk_text": """Electric Field and Field Lines
                Electric field: Region where electric force acts on a charge. Field intensity E = F/q.
                Field lines: Imaginary lines showing field direction. Properties: originate from +ve, terminate at -ve.
            ...
            },
            {
                "chunk_id": "cbse_003",
                "document_id": "cbse_physics_electrostatics",
                "chunk_text": """Capacitors and Dielectrics
                Capacitor: Device to store electrical energy. Capacitance C = Q/V measured in Farads.
                Parallel plate capacitor: C = ε₀εᵣA/d where εᵣ is dielectric constant.
                Energy stored: U = ½QV = ½CV²
                Applications: Flash circuits, filters, detuning circuits.""",
                "embedding": None,
                "metadata": {
                    "topic": "Electrostatics",
                    "difficulty": "Advanced",
    ...
    @staticmethod
    def get_mock_chunks_python() -> List[Dict[str, Any]]:
        """Mock RAG chunks for Python programming curriculum."""
        return [
            {
                "chunk_id": "py_001",
                "document_id": "python_week1_curriculum",
                "chunk_text": """Python Basics - Variables and Data Types
                Variables: Named containers for data. No need to declare type (dynamic typing).
                Basic types: int, float, str, bool.
                String operations: concatenation, slicing, methods like upper(), lower(), split().
                Type conversion: int(), str(), float() functions.""",
                "embedding": None,
                "metadata": {
                    "topic": "Fundamentals",
                    "difficulty": "Beginner",
            ...
            },
            {
                "chunk_id": "py_002",
                "document_id": "python_week1_curriculum",
                "chunk_text": """Control Flow - If Statements and Loops
            ...
            },
            {
                "chunk_id": "py_003",
                "document_id": "python_week1_curriculum",
                "chunk_text": """Lists and Dictionaries
                Lists: Ordered, mutable collections. Operations: append, insert, remove, pop.
                Indexing and slicing: list[0], list[1:3], list[-1].
                Dictionaries: Key-value pairs. Creating: {key: value}. Access: dict[key].
